...
Dit project werd uitgevoerd voor meerdere Belgische keuringsbedrijven. Deze organisaties hanteren een gestandaardiseerde softwareoplossing voor het beheer van keuringsdocumenten en de generatie van officiële keuringsbewijs.
...
Zo is een simpele webapplicatie uitgewerkt die d.m.v. een QR-code op het keuringsbewijs geraadpleegt kan worden. Ook is een integratie met Mijn Burgerprofiel voorzien om de gegevens op te vragen zonder het bewijs in handen te hebben.
...
In een latere fase van het project is ook beslist om dit portaal uit te bereiden met een Peppol integratie. Zo kunnen klanten van de keuringsmaatschappijen zelfstanding hun factuur aanvragen en versturen via Peppol. Dit verlaagt de workload bij de bedrijven en zorgt ervoor dat iedereen zijn keuringen correct en vlot in de boekhouding komen.
...
**Context:** Professioneel project voor Orbid
